...
Config.container_depots = {
    ...
    ["Storage Depot"] = {
        name = "Storage Depot",
        positions = {
            vector2(-1707.58, -725.00),
 vector2(-1728.03, -749.24),
 vector2(-1640.15, -820.45),
 vector2(-1619.70, -793.94)
        },
        minz = 9.00,
        maxz = 11.00,
        blip = {
            name = "Storage Containers Depot",
            coords = vector3(-1718.19, -736.52, 10.19),
            scale = 1.5,
            color = 43,
            sprite = 677
        }
